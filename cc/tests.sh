...
assert 2 'int main() { int i; i = 0; ++i; return ++i; }'
assert 3 'int main() { int i; i = 0; ++i; ++i; return ++i; }'
assert 1 'int main() { int i; i = 3; --i; return --i; }'
assert 0 'int main() { int i; i = 3; --i; --i; return --i; }'

assert 1 'int main() { int i; i = 0; i++; return i++; }'
assert 2 'int main() { int i; i = 0; i++; i++; return i++; }'
assert 2 'int main() { int i; i = 3; i--; return i--; }'
assert 1 'int main() { int i; i = 3; i--; i--; return i--; }'
